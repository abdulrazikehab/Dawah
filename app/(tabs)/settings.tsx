...
import { View, Text, StyleSheet, ScrollView, TouchableOpacity, Switch, Image, Alert, Modal, TextInput, Linking } from 'react-native';
import * as ImagePicker from 'expo-image-picker';
import { SafeAreaView } from 'react-native-safe-area-context';
import { useRouter } from 'expo-router';
import { 
  User, Bell, Lock, CreditCard, HelpCircle, LogOut, 
  ChevronLeft, Globe, Star, Shield, FileText, MessageCircle, Sun, Moon, Camera
    ...
    Alert.alert(
      ...
      [
        ...
        { text: t.logout, style: 'destructive', onPress: () => {
          Alert.alert(t.done, t.logoutSuccess);
        }},
      ]
    );
  };
        ...
        >
          <View style={[styles.profileSection, { backgroundColor: colors.backgroundCard, borderColor: colors.border }]}>
            ...
            <View style={styles.profileInfo}>
              <Text style={[styles.profileName, { color: colors.text }]}>أحمد محمد</Text>
              <Text style={[styles.profileEmail, { color: colors.textSecondary }]}>ahmed@example.com</Text>
            </View>
