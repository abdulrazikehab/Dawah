...
export default function EventDetailsScreen() {
  ...
  const invitationLink = getInvitationLink(id!);
  ...
  return (
    <View style={styles.container}>
      ...
      <ScrollView showsVerticalScrollIndicator={false}>
        ...
        {invitation.employees && invitation.employees.length > 0 && (
          <View style={styles.employeesSection}>
            <Text style={styles.sectionTitle}>طاقم التنظيم (الأمن)</Text>
            <View style={styles.employeesGrid}>
              {invitation.employees.map((emp: any) => (
                <View key={emp.id} style={styles.employeeMiniCard}>
                  <View style={styles.employeeAvatarMini}>
                    <Text style={styles.employeeAvatarTextMini}>{emp.name?.[0]}</Text>
                  </View>
                  <Text style={styles.employeeTitleMini} numberOfLines={1}>{emp.name}</Text>
                </View>
              ))}
            </View>
          </View>
